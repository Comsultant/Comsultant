...
//        BufferedReader br = new BufferedReader(new FileReader("/home/hadoop/Project/comsultant_out.txt"));
        BufferedReader br = new BufferedReader(new FileReader("E:\\SSAFY_BIGDATA\\mongo\\pcpart.csv"));
        String str;
...
//            System.out.println(pdoc.get("date"));
    ...
    public static void parseString() throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("E:\\SSAFY_BIGDATA\\mongo\\pcpart.txt"));
