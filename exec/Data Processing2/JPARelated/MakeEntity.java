...
public class MakeEntity {
	...
	public static void main(String[] args) throws IOException {
		...
		int num = 8; //cpu(0), vga(1), ram(2), power(3), mb(4), cooler(5), case(6), hdd(7), ssd(8)
		...
		for(int i = start; i<=end; i++) {
			...
			if(allow_null.equals("N")) {
				allow_null = "nullable = false, ";
			} else allow_null = ""; 
			...
			//나머지컬럼
			String column = "\r\n" + 
					"    @Column(name = \"" + name + "\", " + option2 + allow_null + "columnDefinition = \"" + type + "\")\r\n" + 
					option1 +
					"    private "+ jpatype + " " + jpaname + ";";
